...
class ColorShapeController extends Controller
{
	/**
	 ...
	 * @return ColorShape the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ColorShape::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ColorShape $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='color-shape-form')
		{
