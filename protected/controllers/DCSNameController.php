...
class DCSNameController extends Controller
{
	/**
	 ...
	 * @return DCSName the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=DCSName::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DCSName $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='dcsname-form')
		{
