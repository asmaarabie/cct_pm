...
class IsoHeaderController extends Controller
{
	/**
	...
	public function actionAdmin()
	{
		if ($this->can('admin')) {
			...
			if(isset($_GET['IsoHeader']))
				$model->attributes=$_GET['IsoHeader'];
	 ...
	 * @return IsoHeader the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=IsoHeader::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param IsoHeader $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='iso-header-form')
		{
