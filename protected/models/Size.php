...
class Size extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('scale_number, scale_size, scale_name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'dCSSizeScales' => array(self::HAS_MANY, 'DCSSizeScale', 'size_scale'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('scale_number',$this->scale_number,true);
		$criteria->compare('scale_size',$this->scale_size,true);
		$criteria->compare('scale_name',$this->scale_name,true);
